...
public class Blobs {
    public static void main(String[] args) {
        ...
        int output[] = new int[numberOfTests];
        int i = 0;

        while (i < numberOfTests) {
            double foodAvailable = sc.nextDouble();
            
            output[i] = AnalisaDias(foodAvailable);
    ...
    private static int AnalisaDias(double foodAvailable) {
        int days = 0;
        while(foodAvailable > 1){
            foodAvailable /= 2;
            days++;
        }
        return days;
